            ...
            <div class="col-md-10 mt-5 pt-5">
                <div class="row z-depth-3">
                    ...
                    <div class="col-sm-8 bg-white rounder-right">
                     <button class="" style="margin-left:83%;  padding:24px; border:none; background-color:white;"><a style="color:black; font-size:40px" class="" href="{{route('profil.index')}}"><ion-icon name="close-outline"></ion-icon></a></button>

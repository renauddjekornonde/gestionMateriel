...
@endif
                     <form action="{{route('affectation.store')}}" method="POST">
                        @csrf
            <fieldset>
              <legend>Ajouter une Affectation</legend>
          
              <div class="mb-3">
                <select id="salle" name="salle" class="form-select">
                   <option value= "..." >Libelle Salle</option>
              ...
              <div class="mb-3">
                ...
                <input type="hidden" name="moreFields[0][typeOperation]" value="0">
              </div>
              </td>
